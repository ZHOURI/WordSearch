...
<head>
    ...
    <script>
        $(function () {
            ...
            sendAjax("${pageContext.request.contextPath}/man/addWord");
        })
    </script>
</head>
<body>
<div class="container" style="width: 50%;">
    <h3 style="text-align: center;">添加宿舍报修记录</h3>
    <form action="${pageContext.request.contextPath}/man/addWord" method="post" id="myform">
        ...
        <div class="form-group">
            <label>出处：</label><br/>
            <textarea name="derivation" rows="10" style="width: 100%"></textarea>
        </div>
        <div class="form-group">
            <label>解释：</label><br/>
            <textarea name="explanation" rows="10" style="width: 100%"></textarea>
        </div>
        <div class="form-group">
            <label>示例：</label>
            <textarea id="editor-zh" name="example" rows="10"></textarea>
        </div>
