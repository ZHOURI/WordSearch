...
<head>
    ...
    <script>
        $(function () {
            ...
            sendAjax("${pageContext.request.contextPath}/user/editUser");
        })
    </script>
</head>
<body>
<div class="container" style="width: 50%;">
    ...
    <form action="" method="post" id="myform">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="word" name="username" value="${User.username}" />
        </div>
        <div class="form-group">
            <label for="pinyin">密码：</label>
            <input type="text" class="form-control" id="pinyin" name="password" value="${User.password}"  />
        </div>
